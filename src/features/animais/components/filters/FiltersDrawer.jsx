...
function FiltersDrawer({ isOpen, onClose, resultsCount, ...panelProps }) {
  return (
    <>
      <div
      ...
      >
        ...
        {/* Contagem de resultados ao vivo — os filtros já reagem antes do clique */}
        <div className="border-t border-slate-100 p-5">
          ...
          >
            Ver {resultsCount} {resultsCount === 1 ? 'animal' : 'animais'}
          </button>
        </div>
      </div>
    </>
