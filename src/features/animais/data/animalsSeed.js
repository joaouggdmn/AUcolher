const baseAnimals = [
  ...
  },
  {
    ...
    ownerPhotoUrl: 'https://images.unsplash.com/photo-1489980557514-251d61e3eeb6?auto=format&fit=crop&w=200&q=80',
    ownerId: 2,
    vaccinated: true,
    neutered: false,
    dewormed: true,
  ...
  },
  {
    ...
    ownerPhotoUrl: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&w=200&q=80',
    ownerId: 3,
    vaccinated: true,
    neutered: false,
    dewormed: true,
...
// buildExtraAnimals() e export const animalsSeed = [...] permanecem EXATAMENTE
// como estavam — como reaproveitam `...base`, herdam os campos novos sozinhos
