export const baseAnimals = [
  {
    ...
    ownerName: "Patinhas Carentes", // 🆕 usado no chat quando o adotante vê o contato
    ownerPhotoUrl: null, // 🆕 null → UI cai no fallback de inicial/ícone
    ownerId: 1,
    vaccinated: true,
    neutered: true,
    dewormed: true,
  ...
  },
  {
    ...
    ownerPhotoUrl: 'https://images.unsplash.com/photo-1502685104226-ee32379fefbe?auto=format&fit=crop&w=200&q=80', // 🆕
    ownerId: 6,
    vaccinated: true,
    neutered: true,
    dewormed: false,
  ...
  },
  {
    ...
    ownerPhotoUrl: 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?auto=format&fit=crop&w=200&q=80', // 🆕
    ownerId: 7,
    vaccinated: true,
    neutered: false,
    dewormed: true,
