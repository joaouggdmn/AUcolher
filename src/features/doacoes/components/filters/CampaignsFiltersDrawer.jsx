// components/filters/CampaignsFiltersDrawer.jsx
import { FaXmark } from 'react-icons/fa6'
import CampaignsFiltersPanel from './CampaignsFiltersPanel'

function CampaignsFiltersDrawer({ isOpen, onClose, resultsCount, ...panelProps }) {
  return (
    <>
      <div
      ...
      >
        <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
          <h2 className="text-lg font-extrabold tracking-tight text-emerald-950">Filtros</h2>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto px-5 py-1">
          <CampaignsFiltersPanel {...panelProps} />
        </div>
        ...
        <div className="border-t border-slate-100 p-5">
          ...
          >
            Ver {resultsCount} {resultsCount === 1 ? 'campanha' : 'campanhas'}
          </button>
        </div>
      </div>
    </>
...
export default CampaignsFiltersDrawer