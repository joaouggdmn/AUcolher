...
function UserProfilePage() {
  ...
  const {
    ...
    handleCepChange,
  } = useCepLookup((address) => {
    handleFieldChange("cidade", address.city); // nomenclatura PT (herdada do AuthContext)
    handleFieldChange("estado", address.state);
  });
    ...
    <div className="mx-auto max-w-4xl px-4 pb-20 pt-24 sm:px-6 lg:pt-28">
      ...
      <form onSubmit={handleSave} className="flex flex-col gap-6">
        <ProfileSection
          icon={FaUser}
          title="Dados básicos"
          description="Suas informações de identificação"
        >
        ...
        <ProfileSection
          icon={FaLocationDot}
          title="Localização"
          description="Essencial para encontrar pets perto de você"
        >
          <div className="mb-4">
            <CepField
              cep={cep}
